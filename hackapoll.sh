...
COUNTRIES="BG AR AU AT BE BR BF CA CZ CR DK EE FI FR DE GR HK IS IN IE IL IT JP JP-FREE KR LV LT LU MD MX MY"
COUNTRIES="${COUNTRIES} NL-FREE NZ NO PL PT RO RU RS SG SI SK ZA ES SE CH TW TR UA AE UK US-FREE"
COUNTRIES_XL="US-AZ US-CO US-WA NL US-CA US-FL US-GA US-IL US-NJ US-NY US-TX US-UT US-VA"
